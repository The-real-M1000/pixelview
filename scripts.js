...
// Referencia al botón de mostrar instrucciones y contenedor
...
if (showInstructionsButton) {
  showInstructionsButton.addEventListener('click', () => {
    if (instructionsContainer.style.display === 'none' || instructionsContainer.style.display === '') {
      instructionsContainer.style.display = 'block'; // Mostrar instrucciones
    } else {
      instructionsContainer.style.display = 'none'; // Ocultar instrucciones
    }
  });
}
